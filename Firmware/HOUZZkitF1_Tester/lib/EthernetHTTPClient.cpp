...
/**
 * EthernetHTTPClient.cpp
 *
 * Created on: 02.11.2015
 *
 * Copyright (c) 2015 Markus Sattler. All rights reserved.
 * This file is part of the EthernetHTTPClient for Arduino.
...
#ifdef EthernetHTTPClient_1_1_COMPATIBLE
...
public:
    ...
    virtual std::unique_ptr<EthernetClient> create()
    {
        return std::unique_ptr<EthernetClient>(new EthernetClient());
    }

    virtual bool verify(EthernetClient& client, const char* host)
    {
        return true;
    }
};
...
public:
    ...
    std::unique_ptr<EthernetClient> create() override
    {
        return std::unique_ptr<EthernetClient>(new EthernetClient());
    }

    bool verify(EthernetClient& client, const char* host) override
    {
        EthernetClient& wcs = static_cast<EthernetClient&>(client);
        if (_cacert == nullptr) {
            // wcs.setInsecure();
        } else {
...
#endif // EthernetHTTPClient_1_1_COMPATIBLE

/**
 * constructor
 */
EthernetHTTPClient::EthernetHTTPClient()
{
}
 ...
 * @return success bool
 */
bool EthernetHTTPClient::begin(EthernetClient &client, String url) {
    Serial.println("EthernetHTTPClient::begin 1");
#ifdef EthernetHTTPClient_1_1_COMPATIBLE
    if(_tcpDeprecated) {
...
#endif
    Serial.println("EthernetHTTPClient::begin 2");
    Serial.println(url);
    _client = &client;
 ...
 * @return success bool
 */
bool EthernetHTTPClient::begin(EthernetClient &client, String host, uint16_t port, String uri, bool https)
{
#ifdef EthernetHTTPClient_1_1_COMPATIBLE
    if(_tcpDeprecated) {
        log_d("mix up of new and deprecated api");
...
#ifdef EthernetHTTPClient_1_1_COMPATIBLE
bool EthernetHTTPClient::begin(String url, const char* CAcert)
{
 ...
 * @param url String
 */
bool EthernetHTTPClient::begin(String url)
{
    if(_client && !_tcpDeprecated) {
        log_d("mix up of new and deprecated api");
        _canReuse = false;
...
bool EthernetHTTPClient::beginInternal(String url, const char* expectedProtocol)
{
...
#ifdef EthernetHTTPClient_1_1_COMPATIBLE
bool EthernetHTTPClient::begin(String host, uint16_t port, String uri)
{
    if(_client && !_tcpDeprecated) {
        log_d("mix up of new and deprecated api");
        _canReuse = false;
...
bool EthernetHTTPClient::begin(String host, uint16_t port, String uri, const char* CAcert)
{
    if(_client && !_tcpDeprecated) {
        log_d("mix up of new and deprecated api");
        _canReuse = false;
...
bool EthernetHTTPClient::begin(String host, uint16_t port, String uri, const char* CAcert, const char* cli_cert, const char* cli_key)
{
    if(_client && !_tcpDeprecated) {
        log_d("mix up of new and deprecated api");
        _canReuse = false;
 ...
 */
void EthernetHTTPClient::end(void)
{
    disconnect(false);
    clear();
}
 ...
 */
void EthernetHTTPClient::disconnect(bool preserveClient)
{
    if(connected()) {
 ...
 */
bool EthernetHTTPClient::connected()
{
    if(_client) {
 ...
 * @param reuse bool
 */
void EthernetHTTPClient::setReuse(bool reuse)
{
    _reuse = reuse;
}
 ...
 */
void EthernetHTTPClient::setUserAgent(const String& userAgent)
{
 ...
 */
void EthernetHTTPClient::setAuthorization(const char * user, const char * password)
{
    if(user && password) {
        String auth = user;
        auth += ":";
 ...
 */
void EthernetHTTPClient::setAuthorization(const char * auth)
{
    if(auth) {
 ...
 */
void EthernetHTTPClient::setAuthorizationType(const char * authType)
{
    if(authType) {
 ...
 */
void EthernetHTTPClient::setConnectTimeout(int32_t connectTimeout)
{
 ...
 */
void EthernetHTTPClient::setTimeout(uint16_t timeout)
{
    _tcpTimeout = timeout;
    if(connected()) {
 ...
 * @param use
 */
void EthernetHTTPClient::useHTTP10(bool useHTTP10)
{
 ...
 * @return http code
 */
int EthernetHTTPClient::POST(uint8_t * payload, size_t size)
{
    return sendRequest("POST", payload, size);
}

int EthernetHTTPClient::POST(String payload)
{
 ...
 * @return http code
 */
int EthernetHTTPClient::PATCH(uint8_t * payload, size_t size)
{
    return sendRequest("PATCH", payload, size);
}

int EthernetHTTPClient::PATCH(String payload)
{
 ...
 * @return http code
 */
int EthernetHTTPClient::PUT(uint8_t * payload, size_t size) {
    return sendRequest("PUT", payload, size);
}

int EthernetHTTPClient::PUT(String payload) {
 ...
 * @return
 */
int EthernetHTTPClient::sendRequest(const char * type, String payload)
{
 ...
 */
int EthernetHTTPClient::sendRequest(const char * type, uint8_t * payload, size_t size)
{
    int code;
    bool redirect = false;
 ...
 * @return -1 if no info or > 0 when Content-Length is set by server
 */
int EthernetHTTPClient::sendRequest(const char * type, Stream * stream, size_t size)
{
 ...
 * @return -1 if no info or > 0 when Content-Length is set by server
 */
int EthernetHTTPClient::getSize(void)
{
    return _size;
}
 ...
 * @return WiFiClient
 */
EthernetClient& EthernetHTTPClient::getStream(void)
{
    if (connected()) {
        return *_client;
    }
 ...
 * @return WiFiClient*
 */
EthernetClient* EthernetHTTPClient::getStreamPtr(void)
{
    if(connected()) {
        return _client;
    }
 ...
 */
int EthernetHTTPClient::writeToStream(Stream * stream)
{
 ...
 * @return String
 */
String EthernetHTTPClient::getString(void)
{
 ...
 * @return String
 */
String EthernetHTTPClient::errorToString(int error)
{
    switch(error) {
 ...
 * @param first
 */
void EthernetHTTPClient::addHeader(const String& name, const String& value, bool first, bool replace)
{
...
void EthernetHTTPClient::collectHeaders(const char* headerKeys[], const size_t headerKeysCount)
{
...
String EthernetHTTPClient::header(const char* name)
{
    for(size_t i = 0; i < _headerKeysCount; ++i) {
...
String EthernetHTTPClient::header(size_t i)
{
...
String EthernetHTTPClient::headerName(size_t i)
{
    if(i < _headerKeysCount) {
...
int EthernetHTTPClient::headers()
{
    return _headerKeysCount;
}

bool EthernetHTTPClient::hasHeader(const char* name)
{
    for(size_t i = 0; i < _headerKeysCount; ++i) {
 ...
 */
bool EthernetHTTPClient::connect(void)
{
    if(connected()) {
        if(_reuse) {
    ...
    if (!_client) {
        log_d("EthernetHTTPClient::begin was not called or returned error");
        return false;
    }
#ifdef EthernetHTTPClient_1_1_COMPATIBLE
 ...
 * @return status
 */
bool EthernetHTTPClient::sendHeader(const char * type)
{
    if(!connected()) {
        return false;
    }
 ...
 */
int EthernetHTTPClient::handleHeaderResponse()
{
 ...
 */
int EthernetHTTPClient::writeToStreamDataBlock(Stream * stream, int size)
{
    int buff_size = HTTP_TCP_BUFFER_SIZE;
    int len = size;
    int bytesWritten = 0;
 ...
 * @return error
 */
int EthernetHTTPClient::returnError(int error)
{
    if(error < 0) {
...
void EthernetHTTPClient::setFollowRedirects(followRedirects_t follow)
{
    _followRedirects = follow;
}

void EthernetHTTPClient::setRedirectLimit(uint16_t limit)
{
 ...
 * @param url
 */
bool EthernetHTTPClient::setURL(const String& url)
{
...
const String &EthernetHTTPClient::getLocation(void)
{
    return _location;
}

void EthernetHTTPClient::setCookieJar(CookieJar* cookieJar)
{
    _cookieJar = cookieJar;
}

void EthernetHTTPClient::resetCookieJar()
{
    _cookieJar = nullptr;
}

void EthernetHTTPClient::clearAllCookies()
{
    if (_cookieJar) _cookieJar->clear();
}

void EthernetHTTPClient::setCookie(String date, String headerValue)
{
    if (!_cookieJar)
    {
        return;
...
bool EthernetHTTPClient::generateCookieString(String *cookieString)
{
    time_t now_local = time(NULL);
    time_t now_gmt = mktime(gmtime(&now_local));
